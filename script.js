...
function cargarRespuestasDesdeEnlace() {
  ...
  const opcion1 = params.get('opcion1');
  const opcion2 = params.get('opcion2');
  const imagen1 = params.get('imagen1');
  const imagen2 = params.get('imagen2');

  if (opcion1) {
    const opcion1Radio = document.querySelector(`input[name="opcion1"][value="${opcion1}"]`);
    if (opcion1Radio) {
      opcion1Radio.checked = true;
      mostrarRespuesta(opcion1Radio);
    }
  }

  if (opcion2) {
    const opcion2Radio = document.querySelector(`input[name="opcion2"][value="${opcion2}"]`);
    if (opcion2Radio) {
      opcion2Radio.checked = true;
      mostrarRespuesta(opcion2Radio);
    }
  }

  if (imagen1) {
    const imagen1Contenedor = document.querySelector('#imagen1');
    if (imagen1Contenedor) {
      imagen1Contenedor.setAttribute('src', imagen1);
      imagen1Contenedor.style.display = 'block';
    }
  }

  if (imagen2) {
    const imagen2Contenedor = document.querySelector('#imagen2');
    if (imagen2Contenedor) {
      imagen2Contenedor.setAttribute('src', imagen2);
      imagen2Contenedor.style.display = 'block';
    }
  }
}
